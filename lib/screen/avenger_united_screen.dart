...
class AvengerUnitedScreen extends StatelessWidget {
  static const String routeName = '/avengerunitedscreen';
          ...
          child: SafeArea(
            child: Column(
              children: [
                ...
                AvengerUnitedWidget(), // Thêm TrendingWidget vào MovieScreen
              ],
            ),
          ),
        ),
...
class AvengerUnitedWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final responsive = ResponsiveUtil(context);
